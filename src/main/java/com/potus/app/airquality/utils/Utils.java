...
public class Utils {
    ...
    public static Map<String, Map<String, Double>> getRegionData() {
        ...
        result.put("Alt_Empordà", getAuxMap(42.28, 2.93));
        result.put("Alt_Penedès", getAuxMap(41.36, 1.68));
        result.put("Alt_Urgell", getAuxMap(42.24, 1.41));
        result.put("Alta_Ribagorça", getAuxMap(42.43, 0.86));
        ...
        result.put("Baix_Empordà", getAuxMap(41.95, 3.06));
        result.put("Baix_Llobregat", getAuxMap(41.43, 1.97));
        result.put("Baix_Penedès", getAuxMap(41.22, 1.53));
        result.put("Barcelonès", getAuxMap(41.40, 2.16));
        result.put("Berguedà", getAuxMap(42.11, 1.84));
        result.put("Cerdanya", getAuxMap(42.45, 1.95));
        result.put("Conca_de_Barberà", getAuxMap(41.37, 1.15));
        ...
        result.put("Pallars_Subirà", getAuxMap(42.52, 1.19));
        ...
        result.put("Ripollès", getAuxMap(42.27, 2.26));
        result.put("Segarra", getAuxMap(41.739167, 1.33));
        result.put("Serrià", getAuxMap(42.018056, 2.83));
        result.put("Selva", getAuxMap(41.8647, 2.67));
        result.put("Solsonès", getAuxMap(41.98, 1.51));
        result.put("Tarragonès", getAuxMap(41.15, 1.29));
